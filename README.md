...
```javascript
dmskrsqrt = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-dmskrsqrt@v0.2.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/math-strided-special-dmskrsqrt/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/math-strided-special-dmskrsqrt/actions/workflows/test.yml?query=branch:v0.2.2
